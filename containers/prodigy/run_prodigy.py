...
def run(config_path: Path, output_dir: Path) -> None:
    ...
    output = {
        ...
        "hydrophilic_hydrophilic_contacts": result["LL"],
        "hydrophobic_hydrophilic_contacts": result["BL"],
        "hydrophobic_hydrophobic_contacts": result["BB"],
        "pct_apolar_nis": result["nis_a"],
        "pct_charged_nis": result["nis_c"],
        "pct_polar_nis": result["nis_p"],
